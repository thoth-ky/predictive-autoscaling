...
def train(args):
    ...
    for horizon in y_train_dict.keys():
        ...
        y_train_norm_dict[horizon] = y_scaler[horizon].fit_transform(
            y_train_dict[horizon].reshape(-1, 1)).reshape(y_train_dict[horizon].shape)
        y_val_norm_dict[horizon] = y_scaler[horizon].transform(
    ...
    train_loader, val_loader = create_data_loaders(
        X_train_norm, y_train_norm_dict,
        X_val_norm, y_val_norm_dict,
