...
from src.preprocessing.metric_specific import extract_container_name, build_container_vocabulary, add_container_ids
...
@pytest.mark.integration
def test_data_loader_with_container_ids(synthetic_multi_container_data, container_vocab):
...
@pytest.mark.integration
@pytest.mark.slow
def test_end_to_end_multi_container_training(synthetic_multi_container_data, multi_container_config):
    """
...
@pytest.mark.integration
def test_single_container_backward_compatibility(synthetic_single_container_data, sample_config):
