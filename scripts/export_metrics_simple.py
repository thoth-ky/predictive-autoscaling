...
def export_metrics_simple(seconds=900, output_dir='../data/raw'):
    ...
    queries = {
        'container_cpu': 'rate(container_cpu_usage_seconds_total{id!=""}[1m])',
        'container_memory': 'container_memory_usage_bytes{id!=""}',
        'http_requests': 'rate(http_requests_total[1m])',
        'http_request_duration': 'rate(http_request_duration_seconds[1m])',
    }
